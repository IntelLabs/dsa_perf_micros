...
.. code-block:: console
 ...
 $ git clone https://github.com/intel/dsa_micros.git

2. Use the steps below to build the dsa_micros application
...
The resulting application is available in src/dsa_micros.
